...
Takara Coder는 커뮤니티 주도의 프로젝트이며, 모든 기여를 소중하게 생각합니다. 협업을 간소화하기 위해 [Issue-First](#issue-first-접근법) 원칙을 적용하고 있으며, 이는 모든 [Pull Request (PR)](#pull-request-제출)가 먼저 GitHub Issue와 연결되어야 함을 의미합니다. 이 가이드를 주의 깊게 검토해 주세요.
...
- **기존 Issue 확인:** [GitHub Issues](https://github.com/RooCodeInc/Takara-Coder/issues)를 검색하세요.
- **Issue 생성:** 적절한 템플릿 사용:
    - **버그:** "Bug Report" 템플릿.
...
- 문서 관련은 [Takara Coder Docs](https://github.com/RooCodeInc/Takara-Coder-Docs)를 참조하세요.

### 버그 신고

- 먼저 기존 신고를 확인하세요.
- ["Bug Report" 템플릿](https://github.com/RooCodeInc/Takara-Coder/issues/new/choose)을 사용하여 새 버그를 신고하세요.
- **보안 문제:** [security advisories](https://github.com/RooCodeInc/Takara-Coder/security/advisories/new)를 통해 비공개로 신고하세요.
...
```
git clone https://github.com/당신의_아이디/Takara-Coder.git
```
...
기여함으로써, 귀하의 기여가 Takara Coder의 라이선스와 일치하는 Apache 2.0 라이선스 하에 제공됨에 동의합니다.
