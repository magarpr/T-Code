...
### 3. Dołącz do społeczności Takara Coder
...
- **Sprawdź istniejące issues:** Przeszukaj [GitHub Issues](https://github.com/RooCodeInc/Takara-Coder/issues).
...
- W kwestii dokumentacji odwiedź [Takara Coder Docs](https://github.com/RooCodeInc/Takara-Coder-Docs).

### Zgłaszanie błędów

- Najpierw sprawdź istniejące zgłoszenia.
- Twórz nowe zgłoszenia błędów używając [szablonu "Bug Report"](https://github.com/RooCodeInc/Takara-Coder/issues/new/choose).
- **Luki bezpieczeństwa:** Zgłaszaj prywatnie przez [security advisories](https://github.com/RooCodeInc/Takara-Coder/security/advisories/new).
...
```
git clone https://github.com/TWÓJ_UŻYTKOWNIK/Takara-Coder.git
```
...
Zgłaszając pull request, zgadzasz się, że twój wkład będzie licencjonowany na licencji Apache 2.0, zgodnie z licencją Takara Coder.
