...
# Contribuindo para o Takara Coder

O Takara Coder é um projeto impulsionado pela comunidade e valorizamos muito cada contribuição. Para simplificar a colaboração, operamos com uma abordagem [Issue-First](#abordagem-issue-first), o que significa que todos os [Pull Requests (PRs)](#enviando-um-pull-request) devem primeiro estar vinculados a uma Issue do GitHub. Por favor, leia este guia com atenção.
...
### 3. Junte-se à Comunidade Takara Coder
...
- **Verificar issues existentes:** Procure em [GitHub Issues](https://github.com/RooCodeInc/Takara-Coder/issues).
...
- Para documentação, visite [Takara Coder Docs](https://github.com/RooCodeInc/Takara-Coder-Docs).

### Relatando Bugs

- Verifique primeiro se já existem relatórios.
- Crie novos relatórios de bugs usando o [template "Bug Report"](https://github.com/RooCodeInc/Takara-Coder/issues/new/choose).
- **Vulnerabilidades de segurança:** Relate de forma privada via [security advisories](https://github.com/RooCodeInc/Takara-Coder/security/advisories/new).
...
```
git clone https://github.com/SEU_USUÁRIO/Takara-Coder.git
```
...
Ao enviar um pull request, você concorda que suas contribuições serão licenciadas sob a Licença Apache 2.0, consistente com o licenciamento do Takara Coder.
