...
Takara Coder 是一個由社群驅動的專案，我們深深重視每一份貢獻。為了簡化協作流程，我們採用 [Issue-First](#issue-first-方式) 原則，這表示所有 [Pull Request (PR)](#提交-pull-request) 必須先關聯至 GitHub Issue。請仔細閱讀本指南。
...
- **檢查現有 issue：** 搜尋 [GitHub Issues](https://github.com/RooCodeInc/Takara-Coder/issues)。
- **建立 issue：** 使用適當範本：
    - **Bug：** 「Bug Report」範本。
...
- 文件相關，請訪問 [Takara Coder Docs](https://github.com/RooCodeInc/Takara-Coder-Docs)。

### 回報 Bug

- 先檢查是否已有相關報告。
- 使用 [「Bug Report」範本](https://github.com/RooCodeInc/Takara-Coder/issues/new/choose) 建立新 bug 報告。
- **安全問題：** 透過 [security advisories](https://github.com/RooCodeInc/Takara-Coder/security/advisories/new) 私下回報。
...
```
git clone https://github.com/你的帳號/Takara-Coder.git
```
...
提交貢獻即表示你同意你的貢獻將基於 Apache 2.0 授權條款，與 Takara Coder 的授權一致。
