...
Takara Coder 是一个由社区驱动的项目，我们高度重视每一份贡献。为了简化协作流程，我们采用 [Issue-First](#issue-first-方式) 原则，这意味着所有 [Pull Request (PR)](#提交-pull-request) 必须首先关联到 GitHub Issue。请仔细阅读本指南。
...
- **检查现有 issue：** 搜索 [GitHub Issues](https://github.com/RooCodeInc/Takara-Coder/issues)。
- **创建 issue：** 使用适当模板：
    - **Bug：** "Bug Report" 模板。
...
- 文档相关，请访问 [Takara Coder Docs](https://github.com/RooCodeInc/Takara-Coder-Docs)。

### 报告 Bug

- 先检查是否已有相关报告。
- 使用 ["Bug Report" 模板](https://github.com/RooCodeInc/Takara-Coder/issues/new/choose) 创建新 bug 报告。
- **安全问题：** 通过 [security advisories](https://github.com/RooCodeInc/Takara-Coder/security/advisories/new) 私下报告。
...
```
git clone https://github.com/你的用户名/Takara-Coder.git
```
...
提交贡献即表示你同意你的贡献将基于 Apache 2.0 许可证，与 Takara Coder 的许可一致。
