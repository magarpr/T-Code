...
# Berkontribusi pada Takara Coder
...
### 3. Bergabung dengan Komunitas Takara Coder
...
- **Periksa isu yang ada**: Cari di [GitHub Issues](https://github.com/RooCodeInc/Takara-Coder/issues).
...
- Untuk dokumen, kunjungi [Takara Coder Docs](https://github.com/RooCodeInc/Takara-Coder-Docs).

### Melaporkan Bug

- Periksa laporan yang ada terlebih dahulu.
- Buat bug baru menggunakan ["Bug Report" template](https://github.com/RooCodeInc/Takara-Coder/issues/new/choose).
- **Masalah keamanan**: Laporkan secara pribadi melalui [security advisories](https://github.com/RooCodeInc/Takara-Coder/security/advisories/new).
...
Dengan berkontribusi, kamu setuju kontribusi kamu akan dilisensikan di bawah Lisensi Apache 2.0, konsisten dengan lisensi Takara Coder.
