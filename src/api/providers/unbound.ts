...
import { unboundDefaultModelId, unboundDefaultModelInfo } from "@takara-coder/types"
...
const ORIGIN_APP = "takara-coder"

const DEFAULT_HEADERS = {
	"X-Unbound-Metadata": JSON.stringify({ labels: [{ key: "app", value: "takara-coder" }] }),
}
