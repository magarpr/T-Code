...
import type { ModelInfo, ProviderSettings } from "@takara-coder/types"
import { CLAUDE_CODE_DEFAULT_MAX_OUTPUT_TOKENS, ANTHROPIC_DEFAULT_MAX_TOKENS } from "@takara-coder/types"
