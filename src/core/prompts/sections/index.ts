...
export { getToneAndStyleSection } from "./tone-and-style"
export { getProactivenessSection } from "./proactiveness"
export { getFollowingConventionsSection } from "./following-conventions"
export { getTaskManagementSection } from "./task-management"
