...
import type { CommandId } from "@takara-coder/types"
...
export function getVisibleProviderOrLog(outputChannel: vscode.OutputChannel): ClineProvider | undefined {
	...
	if (!visibleProvider) {
		outputChannel.appendLine("Cannot find any visible Takara Coder instances.")
		return undefined
	}
...
export const openClineInNewTab = async ({ context, outputChannel }: Omit<RegisterCommandOptions, "provider">) => {
	...
	const newPanel = vscode.window.createWebviewPanel(ClineProvider.tabPanelId, "Takara Coder", targetCol, {
		enableScripts: true,
