...
import { CodeActionName, CodeActionId } from "@takara-coder/types"
...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with Takara Coder",
	FIX: "Fix with Takara Coder",
	IMPROVE: "Improve with Takara Coder",
	ADD_TO_CONTEXT: "Add to Takara Coder",
	NEW_TASK: "New Takara Coder Task",
} as const
