import { c as S, g as G } from "./mermaid-bundle.js"
function E(b, g) {
		...
		if (typeof u != "string" && !Array.isArray(u)) {
			for (const i in u)
				if (i !== "default" && !(i in b)) {
					...
					d && Object.defineProperty(b, i, d.get ? d : { enumerable: !0, get: () => u[i] })
				}
		}
	}
				...
				;(function () {
						...
						_setupCodecs: function () {
							...
							return (
								(e._codecs = {
									...
									wav: !!(
										t.canPlayType('audio/wav; codecs="1"') || t.canPlayType("audio/wav")
									).replace(/^no$/, ""),
					...
					u.prototype = {
						init: function (e) {
							...
							return (
								...
								(t._pool = e.pool || 5),
								(t._preload =
									typeof e.preload == "boolean" || e.preload === "metadata" ? e.preload : !0),
								(t._rate = e.rate || 1),
								(t._sprite = e.sprite || {}),
							...
							if (typeof e == "number") (o = e), (e = null)
								...
								if (typeof e > "u" && ((e = "__default"), !n._playLock)) {
									for (var _ = 0, l = 0; l < n._sounds.length; l++)
										n._sounds[l]._paused && !n._sounds[l]._ended && (_++, (o = n._sounds[l]._id))
									_ === 1 ? (e = null) : (o = null)
								}
							}
						...
						mute: function (e, t) {
							...
							for (var o = n._getSoundIds(t), _ = 0; _ < o.length; _++) {
								...
								l &&
									...
									n._webAudio && l._node
										? l._node.gain.setValueAtTime(e ? 0 : l._volume, r.ctx.currentTime)
						...
						on: function (e, t, n, o) {
							var _ = this,
								l = _["_on" + e]
							return typeof t == "function" && l.push(o ? { id: n, fn: t, once: o } : { id: n, fn: t }), _
						},
						off: function (e, t, n) {
							var o = this,
								_ = o["_on" + e],
					...
					;(b.Howler = r),
						...
						typeof S < "u"
							...
							: typeof window < "u" &&
								((window.HowlerGlobal = g), (window.Howler = r), (window.Howl = u), (window.Sound = i))
				})()
				/*!
					...
					;(HowlerGlobal.prototype._pos = [0, 0, 0]),
								...
								(p._orientation = [r, u, i, d, c, h]),
									typeof p.ctx.listener.forwardX < "u"
										? (p.ctx.listener.forwardX.setTargetAtTime(r, Howler.ctx.currentTime, 0.1),
											p.ctx.listener.forwardY.setTargetAtTime(u, Howler.ctx.currentTime, 0.1),
											p.ctx.listener.forwardZ.setTargetAtTime(i, Howler.ctx.currentTime, 0.1),
											p.ctx.listener.upX.setTargetAtTime(d, Howler.ctx.currentTime, 0.1),
											p.ctx.listener.upY.setTargetAtTime(c, Howler.ctx.currentTime, 0.1),
						...
						(Howl.prototype.init = (function (r) {
							return function (u) {
								...
								return (
									...
									(i._onorientation = u.onorientation ? [{ fn: u.onorientation }] : []),
									r.call(this, u)
								)
							}
						})(Howl.prototype.init)),
										...
										(s._pos = [r, u, i]),
											s._node &&
												...
												typeof s._panner.positionX < "u"
													? (s._panner.positionX.setValueAtTime(r, Howler.ctx.currentTime),
														s._panner.positionY.setValueAtTime(u, Howler.ctx.currentTime),
														s._panner.positionZ.setValueAtTime(i, Howler.ctx.currentTime))
								...
								if (s)
									if (typeof r == "number")
										(s._orientation = [r, u, i]),
											s._node &&
												(s._panner ||
													(s._pos || (s._pos = c._pos || [0, 0, -0.5]), g(s, "spatial")),
												typeof s._panner.orientationX < "u"
													? (s._panner.orientationX.setValueAtTime(r, Howler.ctx.currentTime),
						...
						(Howl.prototype.pannerAttr = function () {
							...
							if (u.length === 1)
								...
								else return (c = r._soundById(parseInt(u[0], 10))), c ? c._pannerAttr : r._pannerAttr
							...
							for (var h = r._getSoundIds(d), p = 0; p < h.length; p++)
								if (((c = r._soundById(h[p])), c)) {
									...
									s = {
										coneInnerAngle:
											typeof i.coneInnerAngle < "u" ? i.coneInnerAngle : s.coneInnerAngle,
										coneOuterAngle:
											typeof i.coneOuterAngle < "u" ? i.coneOuterAngle : s.coneOuterAngle,
									...
									var A = c._panner
									A ||
										(c._pos || (c._pos = r._pos || [0, 0, -0.5]), g(c, "spatial"), (A = c._panner)),
								...
								return (
									...
									u._stereo
										...
										: u._pos
											...
											: u._panner &&
												(u._panner.disconnect(0), (u._panner = void 0), i._refreshBuffer(u)),
									r.call(this)
								)
							}
...
export { q as h }
//# sourceMappingURL=chunk-pO14Kfwb.js.map
