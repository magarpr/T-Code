...
export function ContactForm({ formType, buttonText, buttonClassName }: ContactFormProps) {
	...
	const formDescription =
		formType === "early-access"
			? "Fill out the form below to collaborate in shaping Takara Coder's enterprise solution."
			: "Fill out the form below to see Takara Coder's enterprise capabilities in action."
