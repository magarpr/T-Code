...
export const metadata: Metadata = {
	title: "Terms of Service - Takara Coder",
	description:
		"Terms of Service for Takara Coder Cloud. Learn about our service terms, commercial conditions, and legal framework.",
}
			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						Takara Coder Cloud Terms of Service
					</h1>
					...
					<ul className="lead">
						<li>
							...
							executed by Takara Coder and the customer that references these TOS; <strong>and</strong>
						</li>
						<li>
							<strong>(b)</strong> any{" "}
					...
					<p>
						If Takara Coder and Customer later execute a Master Subscription Agreement (&quot;
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								...
								<tr className="bg-muted/25">
									...
									<td className="border border-border px-4 py-2">
										Takara Coder maintains commercially reasonable administrative, physical, and
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Takara Coder <strong>does not</strong> use Customer Content to train, fine-tune,
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Takara Coder may identify Customer (name & logo) in marketing materials unless
					...
					<ol>
						...
						<li>
							...
							<br />
							Deleted – Takara Coder offers no trials, pilots, betas, or SLA credits under these TOS.
						</li>
						<li>
					...
					<p>
						...
						) explains how Takara Coder collects and handles personal information. If Customer requires a
						DPA, email{" "}
					...
					<ol>
						<li>
							...
							<br />
							Customer may not assign the Agreement without Takara Coder&apos;s prior written consent,
						...
						<li>
							...
							<br />
							Takara Coder may update these TOS by posting a revised version at the same URL and emailing
					...
					<p>
						<strong>Takara Coder, Inc.</strong>
						<br />
