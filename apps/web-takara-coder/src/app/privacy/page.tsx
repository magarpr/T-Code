...
export const metadata: Metadata = {
	title: "Privacy Policy - Takara Coder",
	description:
		"Privacy policy for Takara Coder Cloud and marketing website. Learn how we handle your data and protect your privacy.",
}
			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						Takara Coder Cloud Privacy Policy
					</h1>
					<p className="text-muted-foreground">Last Updated: June 19, 2025</p>

					<p className="lead">
						This Privacy Policy explains how Takara Coder, Inc. (&quot;Takara Coder,&quot; &quot;we,&quot;
					...
					<ul className="lead">
						...
						<li>
							create an account for, sign in to, or otherwise use <strong>Takara Coder Cloud</strong> at{" "}
							<strong>app.roocode.com</strong> or through the Takara Coder extension while authenticated
					...
					<div className="my-8 rounded-lg border border-border bg-muted/50 p-6">
						...
						<p className="mb-0">
							If you run the Takara Coder extension <strong>without</strong> connecting to a Cloud
							account, your data is governed by the standalone{" "}
							<a
								href="https://github.com/RooCodeInc/Takara-Coder/blob/main/PRIVACY.md"
								target="_blank"
								rel="noopener noreferrer"
								className="text-primary hover:underline">
								Takara Coder Extension Privacy Policy
							</a>
							.
						</p>
					</div>
					...
					<ul>
						<li>
							<strong>Your source code never transits Takara Coder servers.</strong> It stays on your
							device and is sent <strong>directly</strong>—via a client‑to‑provider TLS connection—to the
							third‑party AI model you select. Takara Coder never stores, inspects, or trains on your
							code.
						</li>
						<li>
							<strong>Prompts and chat snippets are collected by default</strong> in Takara Coder Cloud so
							you can search and re‑use past conversations. Organization admins can disable this
							collection at any time.
						</li>
						<li>
							We collect only the data needed to operate Takara Coder Cloud, do <strong>not</strong> sell
					...
					<ul>
						<li>
							<strong>Operate & secure Takara Coder Cloud</strong> (authentication, completions, abuse
							prevention)
						</li>
						<li>
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Takara Coder servers; ad networks; model‑training pipelines
									</td>
								</tr>
								<tr className="bg-muted/25">
									<td className="border border-border px-4 py-2 font-medium">
									...
									<td className="border border-border px-4 py-2">
										Takara Coder Cloud (encrypted at rest)
									</td>
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Takara Coder servers (we store only the Stripe customer ID)
									</td>
								</tr>
							</tbody>
						</table>
					...
					<ul>
						<li>
							<strong>Source Code:</strong> Never stored on Takara Coder servers.
						</li>
						<li>
					...
					<ul>
						...
						<li>
							...
							<strong>Security Settings</strong> inside Takara Coder Cloud.
						</li>
					</ul>
