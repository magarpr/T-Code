...
import { globalSettingsSchema, providerSettingsSchema, EVALS_SETTINGS, getModelId } from "@takara-coder/types"
									...
									<>
										<div className="flex items-center gap-1 p-2 border-b">
											...
											<div className="text-sm">
												Imported valid Takara Coder settings. Showing differences from default
												settings.
											</div>
										</div>
