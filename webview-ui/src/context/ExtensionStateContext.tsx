...
export const ExtensionStateContextProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
	...
	const contextValue: ExtensionStateContextType = {
		...
		autoCloseRooTabs: (state as any).autoCloseRooTabs,
		setAutoCloseRooTabs: (value) => {
			setState((prevState) => ({ ...prevState, autoCloseRooTabs: value }) as any)
		},
		autoCloseAllRooTabs: (state as any).autoCloseAllRooTabs,
		setAutoCloseAllRooTabs: (value) => {
			setState((prevState) => ({ ...prevState, autoCloseAllRooTabs: value }) as any)
		},
	}
