...
- Add Takara Coder Cloud Waitlist CTAs (thanks @brunobergher!)
...
- Add IPC types to takara-coder.d.ts
...
- You can now toggle the `terminal.integrated.inheritEnv` VSCode setting directly for the Takara Coder settings (thanks @KJ7LNW)
...
- Fix a nasty bug that would cause Takara Coder to hang, particularly in orchestrator mode
...
- Simplify and streamline Takara Coder's quick actions
- Allow Takara Coder settings to be imported from the welcome screen (thanks @julionav)
...
- Focus Takara Coder in the sidebar when running tasks in the sidebar via the API
- Improve subtasks UI
...
- Add command to focus Takara Coder input field (thanks @axkirillov!)
...
- Allow processes to access the Takara Coder API via a unix socket
...
- Add an activation command that other extensions can use to interface with Takara Coder (thanks @gtaylor!)
...
- Internationalize Takara Coder into Catalan, German, Spanish, French, Hindi, Italian, Japanese, Korean, Polish, Portuguese, Turkish, Vietnamese, Simplified Chinese, and Traditional Chinese (thanks @feifei325!)
...
- Add opt-in telemetry to help us improve Takara Coder faster (thanks Cline!)
...
- Add support for a .rooignore to prevent Takara Coder from read/writing certain files, with a setting to also exclude them from search/lists (thanks Cline!)
...
- Add a new “Human Relay” provider that allows you to manually copy information to a Web AI when needed, and then paste the AI's response back into Takara Coder (thanks @NyxJae)!
...
- Fix context window truncation math (see [#1173](https://github.com/RooCodeInc/Takara-Coder/issues/1173))
...
- Introducing Takara Coder 3.7, with support for the new Claude Sonnet 3.7. Because who cares about skipping version numbers anymore? Thanks @lupuletic and @cte for the PRs!
...
- New Takara Coder community Discord at https://roocode.com/discord!
...
- **Name Change From Roo Cline to Takara Coder:** We're excited to announce our new name! After growing beyond 50,000 installations, we've rebranded from Roo Cline to Takara Coder to better reflect our identity as we chart our own course.

- **Custom Modes:** Create your own personas for Takara Coder! While our built-in modes (Code, Architect, Ask) are still here, you can now shape entirely new ones:
...
- This release adds chat modes! Now you can ask Takara Coder questions about system architecture or the codebase without immediately jumping into writing code. You can even assign different API configuration profiles to each mode if you prefer to use different models for thinking vs coding. Would love feedback in the new Takara Coder Reddit! https://www.reddit.com/r/RooCode
...
- Incorporate Premshay's [PR](https://github.com/RooCodeInc/Takara-Coder/pull/60) to add support for Amazon Nova and Meta Llama Models via Bedrock (3, 3.1, 3.2) and unified Bedrock calls using BedrockClient and Bedrock Runtime API
...
- Incorporate dbasclpy's [PR](https://github.com/RooCodeInc/Takara-Coder/pull/54) to add support for gemini-exp-1206
...
- Fix https://github.com/RooCodeInc/Takara-Coder/issues/50 where sound effects were not respecting settings
...
- Incorporate lloydchang's [PR](https://github.com/RooCodeInc/Takara-Coder/pull/42) to add support for OpenRouter compression
